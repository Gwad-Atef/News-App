          ...
          Row(
            children: <Widget>[
              ...
              Column(
                ...
                children: <Widget>[Text('Christina'), Text('1 hour')],
              )
            ],
          ),
          SizedBox(
              ...
              Flexible(
                child: TextField(
                  decoration: InputDecoration(
                      border: InputBorder.none, hintText: 'Writte Comment Here',
                      contentPadding: EdgeInsets.only(left: 16.0 , top: 24 , bottom: 28)
                      ),
                ),
              ),
              FlatButton(
